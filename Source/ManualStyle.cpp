                                          ...
                                          float sliderPos, float a0, float a1, juce::Slider& s)
{
    ...
    if (isSwitch)
    {
        // Commutateur rotatif SPEED : 3 crans etiquetes 7.5 / 15 / 30 IPS.
        // Rayon plus court que sur les cadrans : le cran du haut (TRI) porte
        ...
        static const char* names[numPos] = { "7.5", "15", "30" };
