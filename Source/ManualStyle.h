...
// (Tape = brun oxyde, la poudre magnetique de la bande).
...
namespace palette
{
    ...
    inline const juce::Colour spot     { 0xffa9713c };   // encre spot du Tape (brun oxyde magnetique)
}
...
// Dessine les cadrans "symbole schematique" et le commutateur rotatif SPEED
